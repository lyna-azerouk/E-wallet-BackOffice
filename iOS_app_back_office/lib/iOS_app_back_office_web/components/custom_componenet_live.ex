defmodule IOSAppBackOfficeWeb.CustomComponenetLive do
  ...
  def navbar(assigns) do
    ~H"""
    <header class="inset-x-100 top-0  mx-auto w-2/3 mt-2 border border-gray-100 bg-white/80 py-3 shadow backdrop-blur-lg md:top-6 md:rounded-3xl">
      <div class="px-4">
  ...
  defp color_class("deactivated"), do: "bg-gray-200"
